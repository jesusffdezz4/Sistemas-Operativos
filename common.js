...
var $exe = {
    init: function() {
        ...
        $('.feedbackbutton.feedback-toggler').click(function() {
            ...
            if (this.value == $exe_i18n.showFeedback || this.value == $exe_i18n.hideFeedback)
                changeText = true;
                    ...
                    if (currTit.indexOf(query) != -1 || currHTML.toLowerCase().indexOf(query) != -1) {
                        ...
                        if (a.length == 1) {
                            ...
                            if (currHTML == "")
                                ...
                                res += '<li><strong><a href="' + a.attr("href") + '" \
        ...
        if (typeof ($.prettyPhoto) != 'undefined') {
            ...
            lightboxLinks.each(function(i) {
                ...
                if (isAudio || isVideo) {
                    ...
                    if (isAudio)
                        hiddenPlayer.html('<div class="exe-media-audio-box"><audio controls="controls" src="' + ref + '" class="exe-media-box-element exe-media-box-audio"><a href="' + ref + '">audio/mpeg</a></audio></div>');
                    else
                        hiddenPlayer.html('<div class="exe-media-video-box"><video width="480" height="385" controls="controls" class="exe-media-box-element"><source src="' + ref + '" /></video></div>');
    ...
    dl: {
        init: function() {
            ...
            $('.exe-dl-toggler a').click(function() {
                ...
                var action = 'show';
                if ($(this).attr('title') == $exe_i18n.hide)
                    action = 'hide';
        ...
        toggle: function(e, a) {
            if (e == "show")
                ...
                $(e).parent().next("dd").toggle()
        }
    },
    hasTooltips: function() {
        if ($("A.exe-tooltip").length > 0) {
            var p = "";
            if (typeof (exe_editor_mode) != "undefined")
                p = "/scripts/exe_tooltips/";
    ...
    iDeviceToggler: {
        init: function() {
            ...
            if ($(".iDevice").length < 2 && isEdition == false)
                return false;
...
$exe.cloze = {
    ...
    checkWord: function(e) {
        ...
        if (i == 0 && s == r.length - 1) {
            ...
            return $exe.cloze.checkWordAnswer(e, r)
    },
    ...
    toggleFeedback: function(e, t) {
        ...
        if (n) {
            var r = n.value;
            if (t) {
                if (t.value == $exe_i18n.showFeedback)
                    t.value = $exe_i18n.hideFeedback;
                else
                    t.value = $exe_i18n.showFeedback
            }
            $exe.cloze.toggle(r)
        }
    },
